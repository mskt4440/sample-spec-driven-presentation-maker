...
from scripts.download_aws_icons import _classify_type, _should_extract


class TestShouldExtract:
    def test_service_48_extracted(self):
        assert _should_extract("Architecture-Service-Icons_01302026/Arch_Compute/48/Arch_AWS-Lambda_48.svg")

    def test_resource_48_extracted(self):
        assert _should_extract("Resource-Icons_01302026/Res_Compute/Res_AWS-Lambda_48_Light.svg")

    def test_category_48_extracted(self):
        assert _should_extract("Architecture-Category-Icons_01302026/Arch-Category_Compute_48.svg")

    def test_group_32_extracted(self):
        assert _should_extract("Architecture-Group-Icons_01302026/AWS-Cloud-logo_32.svg")

    def test_group_32_dark_variant_extracted(self):
        assert _should_extract("Architecture-Group-Icons_01302026/AWS-Cloud-logo_32_Dark.svg")

    def test_group_48_not_extracted(self):
        # Group icons live at 32px only; reject any stray 48 in the group dir.
        assert not _should_extract("Architecture-Group-Icons_01302026/AWS-Cloud-logo_48.svg")

    def test_service_32_not_extracted(self):
        # Service icons live at 48px in this script; reject 32 in non-group dirs.
        assert not _should_extract("Architecture-Service-Icons_01302026/Arch_Compute/32/Arch_AWS-Lambda_32.svg")

    def test_non_svg_not_extracted(self):
        assert not _should_extract("Architecture-Group-Icons_01302026/AWS-Cloud-logo_32.png")
