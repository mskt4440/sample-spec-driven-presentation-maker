...
def get_preview(deck_id: str, slugs: list[str], quality: str = "high") -> list:
    ...
    - quality="low" (800px): Review all slides — check flow, structure, consistency.
    - quality="high" (1280px): Precise review — check text, layout details.

    Args:
        deck_id: Deck directory path.
        slugs: List of slide slugs to preview (required). Example: ["intro", "pricing"].
